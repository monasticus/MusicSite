...
<section class="ens-page border border-info bg-dark">
    ...
    <div class="propositions-table">
        <%@include file="../fragments/performers-propositions.jspf" %>
    </div>
    <div class="propositions-table">
        <%@include file="../fragments/albums-propositions.jspf" %>
    </div>
    <div class="propositions-table">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to discard proposition <span id="itemName"></span>?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button id="deleteId" type="button" class="btn btn-danger">Discard</button>
            </div>
        </div>
    </div>
</div>
