...
<section class="ens-page container border border-danger bg-light">
    ...
    <c:choose>
        <c:when test="${empty tracks}">
            ...
            <a class="btn btn-success btn-lg btn-block" href="/add/track">Add track</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to remove track <span id="itemName"></span>?</p>
            </div>
